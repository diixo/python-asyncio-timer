...
async def some_callback_2(timer_name, context, timer):
    context['count'] += 1
    print('callback: ' + timer_name + ", count: " + str(context['count']))
    if context['count'] == 3:
        timer.cancel()
...
if __name__ == '__main__':
    ...
    timer1 = Timer_Interval(interval=1, first_immediately=True,  timer_name="Timer_1", context={'count': 0}, callback=some_callback_1)
